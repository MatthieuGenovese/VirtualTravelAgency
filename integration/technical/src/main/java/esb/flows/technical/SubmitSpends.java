            ...
            if(type != null) {
                switch (type) {
                    case "submit":
                        ...
                        if(tmpCountry == null || tmpCurrency == null || tmpDate == null || tmpId == null || tmpPrice == null || tmpReason == null){
                            exchange.getIn().setHeader("err", "failinput");
                        }
                        else {
                            if (tmpId.length == 1) {
                    ...
                    case "addSpend":
                        ...
                        asp.setSpend(s);
                        if(p.getCurrency() == null || p.getPrice() == null || s.getCountry() == null || s.getDate() == null || s.getId() == null
                                || s.getPrice() == null || s.getReason() == null){
                            exchange.getIn().setHeader("err", "failinput");
                        }
                        else {
                    ...
                    case "addJustification":
                        ...
                        if(j.getId() == null || j.getJustification() == null || j.getType() == null){
                            exchange.getIn().setHeader("err", "failinput");
                        }
                        else {
